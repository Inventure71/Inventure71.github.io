(function () {
    ...
    const PROJECT_MESSAGES = {
        'Budget Buddy': [
            "Budget Buddy: Mixing Gemini AI with bank-safe guardrails for judge-free coaching.",
            "Budget Buddy: Real-time sentiment analysis helps reduce financial stress in seconds."
        ],
        'Neural Noir': [
            "Neural Noir: Every suspect and alibi is procedurally generated by Gemini AI.",
            "Neural Noir: An autonomous AI judge evaluates your forensic evidence and flair."
        ],
        'HoloVinyl': [
        ...
        'EvolveProject': [
            "EvolveProject: Infinite pokemon-like card generation in Unreal Engine.",
        ],
        ...
        'Core Conflict': [
            "Core Conflict: LLM agents are diagnosing and patching the bytecode in real-time.",
            "Core Conflict: Decentralized synchronization ensures all clients evolve at once."
        ]
    };
    ...
    class ProjectGrandPrix {
        ...
        queueTickerMessage(type, car) {
            ...
            if (specificMessages) {
                ...
                this.tickerQueue.push({ text, color: car.color });
            }
        }
